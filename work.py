...
class MainFrame(wx.Frame):
    ...
    def InitLeftPanel(self, panel):
        ...
        sizer.Add(text, (2, 0), flag=wx.TOP, border=10)
        self.size = wx.Slider(panel, -1, 1, 1, 10, style=wx.SL_HORIZONTAL|wx.SL_AUTOTICKS)
        ...
        # 二维码中间logo
        text = wx.StaticText(panel, -1, "专属标签：")
        sizer.Add(text, (4, 0), flag=wx.TOP, border=5)
        self.logo = filebrowse.FileBrowseButton(panel, -1, labelText="", buttonText="从文件中挑选", toolTip="请选择二维码Logo",
